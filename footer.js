(function () {
  ...
  var css = `
    ...
    /* ─── CITY LAUNCH ─── */
    .mf-city {
      background: #5C3A21; padding: 28px 0; text-align: center;
    }
    ...
    /* ─── MAIN FOOTER ─── */
    .mf-footer { background: #3A2010; padding: 28px 0 0; font-family: 'Poppins', sans-serif; }
      ...
      <div class="mf-top">
        ...
        <div class="mf-brand-col">
          ...
          <div class="mf-social-row">
            <a class="mf-social-btn" href="https://www.instagram.com/maase.india?igsh=eW9mdGQ0ZWI0eTVl&utm_source=qr" target="_blank" rel="noopener" aria-label="Instagram">
            ...
            <a class="mf-social-btn" href="https://x.com/maaseindia98752" target="_blank" rel="noopener" aria-label="Twitter / X">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a class="mf-social-btn" href="https://www.linkedin.com/company/maase-india/" target="_blank" rel="noopener" aria-label="LinkedIn">
